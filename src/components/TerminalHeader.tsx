  ...
  return (
    ...
    >
      <div className="flex items-center px-4 py-2">
        ...
        <div
          ref={scrollRef}
          className="flex items-center gap-2 overflow-x-auto flex-1 min-w-0 nav-scroll"
        >
          <nav className="flex gap-0.5 shrink-0">
            {TABS.map((tab) => (
              <button
                ...
                className="px-3 py-1 text-xs font-mono border transition-colors cursor-pointer shrink-0"
                style={
                  activeTab === tab.id
                    ? {
          ...
          <div className="flex items-center gap-2 shrink-0 ml-auto">
            ...
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-xs font-mono border cursor-pointer transition-colors shrink-0"
                style={{
                  borderColor: 'var(--border-mid)',
                  color: 'var(--fg-dim)',
            ...
            <span className="text-xs font-mono hidden sm:block shrink-0" style={{ color: 'var(--fg-faint)' }}>
